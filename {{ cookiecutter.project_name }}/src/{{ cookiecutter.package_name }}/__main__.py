"""imlp_data_processing file for ensuring the package is executable
as `sample-project` and `python -m imlp_data_processing`
"""
import importlib
...
def _find_run_command_in_plugins(
    plugins,
):
